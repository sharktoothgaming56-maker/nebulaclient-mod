...
public final class NebulaKeybinds {
    ...
    public static final KeyBinding PARTY_MENU = register("key.nebulaclient.party_menu", GLFW.GLFW_KEY_UNKNOWN);
    ...
    public static void init() {
        NebulaClientModClient.LOGGER.info("Registered {} NebulaClient keybinds", 11);
    }
}
