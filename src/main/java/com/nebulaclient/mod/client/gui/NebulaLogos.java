...
public final class NebulaLogos {
    ...
    public static final Identifier MULTIPLAYER = Identifier.of("nebulaclient", "textures/gui/multiplayer_logo.png");
    ...
    public static final int TITLE_W = 655, TITLE_H = 118;
