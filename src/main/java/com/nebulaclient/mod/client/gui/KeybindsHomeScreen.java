...
public class KeybindsHomeScreen extends SpaceTheme.SpaceScreen {
    ...
    protected void renderContent(DrawContext ctx, int mouseX, int mouseY, float delta) {
        // Supplied KEY BINDS artwork as the heading, with the signature
        // accent rule and the helper line beneath it.
        int cx = this.width / 2;
        ...
        SpaceTheme.drawHeaderAccent(ctx, this.textRenderer, cx, logoTop + logoH + 6, logoW / 3,
