...
public final class SpaceTheme {
    ...
    public static class NebulaButton {
        ...
        public void render(DrawContext ctx, MinecraftClient client, int mouseX, int mouseY) {
            ...
            if (hover) { // outer glow line, stroke-coloured
                int glow = 0x30000000 | strokeRgb;
    ...
    public abstract static class SpaceScreen extends Screen {
        ...
        /**
         * Whether to draw the small NEBULACLIENT wordmark bottom-right.
         * Screens that already show the big logo image (title screen) turn
         * this off so the branding isn't duplicated on the same screen.
         */
        protected boolean showCornerWordmark() { return true; }
        ...
        public void render(DrawContext ctx, int mouseX, int mouseY, float delta) {
            ...
            // Big NEBULACLIENT wordmark, bottom-right of every menu that wants it.
            if (showCornerWordmark()) {
