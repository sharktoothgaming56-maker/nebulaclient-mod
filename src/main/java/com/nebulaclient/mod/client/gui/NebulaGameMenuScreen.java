...
public class NebulaGameMenuScreen extends SpaceTheme.SpaceScreen {
    ...
    protected void renderContent(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        int logoTop = this.height / 2 - 76 - logoH - 16; // sit above "Back to Game", leaving room for the accent rule
        ...
        // Space-signature rule tying the pause menu to the rest of the client.
        SpaceTheme.drawHeaderAccent(ctx, this.textRenderer, cx, logoTop + logoH + 7, logoW / 3,
                com.nebulaclient.mod.client.config.NebulaConfig.get().getStrokeColor());
    }
}
