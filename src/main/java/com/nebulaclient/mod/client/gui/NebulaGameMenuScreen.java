...
public class NebulaGameMenuScreen extends SpaceTheme.SpaceScreen {
    ...
    public NebulaGameMenuScreen(java.util.List<net.minecraft.client.gui.widget.ClickableWidget> modExtras) {
    ...
    protected void init() {
        ...
        // Buttons other mods added to the vanilla pause menu, carried over
        // the same way the title screen does it.
        nebulaButtons.addAll(ModCompat.install(modExtras, panelX(), this.height));
