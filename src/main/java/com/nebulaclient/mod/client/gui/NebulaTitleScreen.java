...
public class NebulaTitleScreen extends SpaceTheme.SpaceScreen {
    ...
    protected void init() {
        ...
        // in a column down the left edge. They're the mods' own widget
        // objects, so their click actions are untouched; labelled ones are
        // drawn in the Nebula style (see ModCompat).
