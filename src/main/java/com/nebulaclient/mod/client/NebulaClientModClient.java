...
public class NebulaClientModClient implements ClientModInitializer {
    ...
    private static boolean disconnectToServerList = false;
    ...
    public static void beginDisconnect(boolean toServerList) {
        disconnectPending = true;
        disconnectToServerList = toServerList;
    ...
    public static void pumpDisconnect(MinecraftClient client) {
        ...
        if (current instanceof NebulaTitleScreen
            ...
            reset(); // vanilla routed us fine; nothing to do
            return;
        }
        ...
        reset();
        if (disconnectToServerList) {
            client.setScreen(new net.minecraft.client.gui.screen.multiplayer.MultiplayerScreen(new NebulaTitleScreen()));
        } else {
